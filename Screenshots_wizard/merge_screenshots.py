...
total = i + 1
i = 0
fullimage = Image.new("RGB", (rightmost - leftmost, 9999), "black")
...
out_dir = os.path.dirname(files[0])  # directory of the first selected image

# Ensure directory exists (paranoid, but safe)
if not os.path.isdir(out_dir):
    os.makedirs(out_dir, exist_ok=True)

out_path = os.path.join(out_dir, "stitch.png")

fullimage.save(out_path)
